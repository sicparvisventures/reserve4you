-- ============================================================================
-- FIX CALENDAR FUNCTION CONFLICTS
-- ============================================================================
-- Drop existing conflicting functions and recreate
-- ============================================================================

-- Drop existing functions (if they exist from previous floor plan system)
DROP FUNCTION IF EXISTS get_table_occupancy(UUID, DATE);
DROP FUNCTION IF EXISTS get_table_occupancy(UUID, TIMESTAMPTZ);
DROP FUNCTION IF EXISTS get_calendar_bookings(UUID, DATE, DATE);
DROP FUNCTION IF EXISTS update_booking_time(UUID, DATE, TIME, UUID);
DROP FUNCTION IF EXISTS assign_table_to_booking(UUID, UUID, UUID);
DROP FUNCTION IF EXISTS get_calendar_stats(UUID, DATE);
DROP FUNCTION IF EXISTS check_booking_conflicts(UUID, UUID, DATE, TIME, INT, UUID);
DROP FUNCTION IF EXISTS bulk_update_booking_status(UUID[], booking_status, UUID);

-- ============================================================================
-- RECREATE ALL CALENDAR FUNCTIONS (CONFLICT-FREE)
-- ============================================================================
...
-- 4. GET TABLE OCCUPANCY (TIMELINE)
